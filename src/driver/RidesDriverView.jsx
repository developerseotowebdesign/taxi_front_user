                  ...
                  <>
                      ...
                      <div className="card-body bg-primary text-white rounded-sm">
                        ...
                        <h4 className="card-title text-white">
                          ...
                          <span className="badge rounded-pill bg-danger px-2 py-1 ">
                            <i className="ri-user-2-fill fw-light fs-6" /> Confirmation Pending
                          </span>
                    ...
                    <div className="input-group    input-sm">
                      <select className="form-control" id="state" name="state">
                        ...
                        <option value="6632217bb935242f70d01a68">Delhi</option>
                        <option value="66322181b935242f70d01a6c">Haryana</option>
                        <option value="66322187b935242f70d01a70">Bihar</option>
                        <option value="663221b1b935242f70d01a74">Himachal Pradesh</option> ;
                      </select>
                    </div>
 ...
 {formatTimestamp(Order[0]?.otpEndDate) } */}
              ...
              <div className="card p-3">
                <div className="d-flex justify-content-between">
                  ...
                  <span className="badge badge-primary">
                    Date : {formatDate(Order[0]?.createdAt)}
                  </span>
                </div>
                <hr />
