...
const ValetDriverView = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (inputs.carImagePre === '') {
      if (inputs.carImage) {
        toast.error('Please Chooose Car Image');
  ...
  const fetchUserById = async (phone) => {

    try {
      const { data } = await axiosInstance.get(`/auth-user-phone/${phone}`);
      ...
      if (success) {
        ...
        setInputs((prevData) => ({
          ...
          carImagePre: existingUser.carImage || "",
              ...
              <form className="m-b20 row">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        if (e.target.value.length <= 10) {
                          ...
                          handleUserChange(e); // Call handleChange if length is within limit
                ...
                <div className="mb-4 col-md-4">
                  ...
                  <img
                    ...
                    src={inputs.carImagePre && inputs.carImagePre !== ""
                      ? weburl +
                      inputs.carImagePre
                        .replace(/\\/g, "/")
                        .replace(/^public\//, "")
      ...
      <div className="modal fade" id="addQRModal">
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-body p-4 border-bottom ">
              <QRCode
                value={`https://api.whatsapp.com/send/?phone=%2B91${import.meta.env.VITE_REACT_APP_ADMIN_NO
                  }&text=newuser,VendorId=${Order.VendorId?._id},driverId=${decryptdatajson._id
                  },Valet_Model=${ValetId}`}
            ...
            <>
              <div className="m-auto d-block mb-3" style={{ maxWidth: 350 }}>
                <div className="position-relative">
                  ...
                  {Order?.startStatusOTP === 0 && Order?.endStatusOTP === 0 && (
                    <>
                      <span className="badge rounded-pill bg-danger px-2 py-1 ridestatus">
                        {" "}
                        <i className="ri-taxi-line fw-light fs-6"></i> Not Started
                        Yet
                      </span>
                    </>
                  )}
                  ...
                  {Order?.startStatusOTP === 1 && (
                    <>
                      <span className="badge rounded-pill bg-warning px-2 py-1 ridestatus">
                        {" "}
                        <i className="ri-taxi-line fw-light fs-6"></i> Ride Started
                      </span>
                    </>
                  )}
                  ...
                  {Order?.endStatusOTP === 1 && (
                    <>
                      <span className="badge rounded-pill bg-success px-2 py-1 ridestatus">
                        {" "}
                        <i className="ri-taxi-line fw-light fs-6"></i> Ride
                        Completed
                      </span>
                    </>
                  )}
              ...
              <div className="card p-3 d-block bg-light">
                <div className="d-flex justify-content-between align-items-center mb-2 gap-2">
                  ...
                  >
                    <i className="ri-qr-code-line fs-2"></i>
                  </button>
                  <button
                    type="button"
                  ...
                  {Order?.startStatusOTP === 1 && Order?.endStatusOTP === 0 && (
                    <button
                      type="button"
                      className="btn btn-sm btn-primary mb-2"
                      data-bs-toggle="modal"
                ...
                <div className=" d-block ">
                  {ValetRideUser.map((item) => (
                    <div
                      key={item._id}
                      className={`card m-0 p-3 mb-3 ${(item.userId.carName === "") &
                      ...
                      <div className="d-md-flex gap-2">
                        <div className=" me-2 ">
                          <img
                            ...
                            onError={(e) => {
                              e.target.onerror = null; // Prevent infinite loop in case default image is also broken
                              e.target.src = "/img/car-png.webp"; // Default image path
                            }}
                            style={{
                              width: 100,
                              height: 100,
                          ...
                          <div className="col-7 ">
                            ...
                            <p className="fw-bold  p-0 m-0 mb-2 ">
                              {item.userId.carName !== "" &&
                                item.userId.carNumber !== "" && (
                                  <span
                                    className={`badge mb-2 ${(item.userId.carName === "") &
                                      (item.userId.carNumber === "")
                                      ? "badge-danger cursor"
