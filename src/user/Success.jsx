    ...
    <>
      ...
      <main className="page-content space-top dz-gradient-shape">
        <div className="container">
          <div className="location-tracking bg-white" style={{ height: "70vh" }} >
            {/* Map */}
            ...
            {Order && Order.length > 0 ? (
              <>
                ...
                <img src="/img/success.gif" className="d-block m-auto" style={{ maxWidth: "300px", width: "100%" }} />
                  ...
                  <div className="delivery-man bg-primary">
                    <div className="inner-content">
                      ...
                      <div className="icon-area">
                        ...
                        <Link className="btn btn-primary btn-xs font-13 btn-thin rounded-xl me-2" to="/rides" style={{ backgroundColor: "rgba(255, 255, 255, 0.2)" }}
                        >Track <span className='d-none d-md-block ms-1'> Booking </span> </Link>

                        <Link className="btn btn-secondary btn-xs font-13 btn-thin rounded-xl fw-bold" to="/"
                        >New <span className='d-none d-md-block ms-1'> Booking </span></Link>
                    ...
                    <div className="card border-0 flex-row p-0">
                      ...
                      <div className="card-body p-0 ">
                        <div className="mb-2 input-group input-group-icon mt-1">
                          <p className='p-0 m-0 overflowOne mb-2'>{Order[0]?.PickupLocation}</p>
                        </div>
                        <hr className="p-0 m-0" />
                        <div className="mb-2 input-group input-group-icon mt-1">
                          <p className='p-0 m-0 overflowOne mt-2'>{Order[0]?.DestinationLocation}</p>
                        ...
                        <div className='col-12'>
                          <div className="fs-6 text-left " >
                            ...
                            <button className='btn mb-2 btn-xs btn-primary p-2 d-inline text-start me-2'>
                              ...
                              <p className='p-0 m-0'>  {Order[0]?.pickupTime} Hour </p>
                            </button>
                            ...
                            <button className='btn mb-2 btn-xs btn-secondary p-2 d-inline text-start me-2'>
                              ...
                              <p className='p-0 m-0'>    <b className='fw-bold' > Book Type</b>   </p>
              ...
              <>
                <div className="loading-box text-center d-flex flex-column">
                  ...
                  <i className="ri-loader-2-line spin" style={{ fontSize: 80, color: "white" }} />
                  <h4 className='text-white'> Fetching YOUR ORDER Please wait ....</h4>
