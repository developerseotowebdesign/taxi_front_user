...
const ValetView = ({ updateAuthStatus }) => {
  ...
  const fetchValetAdminData = async () => {
    ...
    try {
      const response = await axiosInstance.get(`/user-admin-valet/${ValetId}`);
  ...
  return (
    <>
      <header className="header header-absolute m-auto style-2 bg-transparent">
        <div className="header-content">
          <div className="left-content">
            <Link className="back-btn border-0 bg-white" to="/valet">
              <i className="ri-arrow-left-line" />
            </Link>
          </div>
          <div class="mid-content"> </div>
          <div className="right-content  gap-4">
            <Link className="back-btn border-0 d-flex align-items-center  bg-white" to="/valet">
              <i className="ri-share-forward-fill h4 m-0" />
            </Link>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="location-tracking">
            ...
            {AdminvaletData && AdminvaletData.length !== 0 ? (
              <>
                ...
                {AdminvaletData.ValetImage &&
                  <Swiper
                    ...
                    ref={swiperRefLocal}
                  >
                    {AdminvaletData.ValetImage.map((image, imageIndex) => (
                ...
                <div className="bg-white p-3 mb-2">
                  <div className="row">
                    <div className="col-11">
                      <h5 className="card-title overflowOne">{AdminvaletData?.ValetName}</h5>
                      <p>{AdminvaletData?.ValetLocation} </p>
                    </div>
                    <div className="col-1 p-0 text-center">
                      <Link target="_blank" to={`http://www.google.com/maps/place/${AdminvaletData.latitude},${AdminvaletData.longitude}`}>
                        <i class="ri-compass-discover-fill h1 me-2 text-primary"></i>
                      </Link>
                    </div>

                    <div className="col-4">
                      <p className="m-0">
                        <i className="ri-map-pin-2-fill text-primary me-2 h4"></i>
                        {
                          (() => {
                            const distance = calculateDistance(
                              parseFloat(latitude),
                              parseFloat(longitude),
                              parseFloat(AdminvaletData.latitude),
                              parseFloat(AdminvaletData.longitude)
                            );
                    ...
                    <div className="col border-left">
                      <p className="m-0">
                        <i className="ri-price-tag-3-fill text-primary me-2 h4" />
                        ₹{AdminvaletData?.dailyCost}
                      </p>
              ...
              <>
                <div className="skeleton" style={{ width: "100%", height: "100%", aspectRatio: "2/1.2", objectFit: "cover" }} >

                </div>

                <div className="skeleton mt-2 mx-auto" style={{ width: "98%", height: "40px" }} />

                <div className="d-flex gap-2 mt-2">
                  <div className="skeleton col-4" style={{ height: "40px" }} />
                  <div className="skeleton col" style={{ height: "40px" }} />
...
<p>You selected: {selectedTime}</p>
              ...
              <div
                ...
                id="basicModal"
                style={{ display: "none", background: '#00000045' }}
                aria-hidden="true"
              >
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    <div className="modal-header">
                      ...
                      <button className="btn-close" data-bs-dismiss="modal">
                        <i class="ri-close-line fw-bold  text-dark h4"></i>
                      </button>
                    </div>
                    <div className="modal-body scrollbar" style={{ maxHeight: 500, overflow: "auto" }} >
                      {isLogin ? (
                        <>
      ...
      <div className="footer-fixed-btn bottom-0 bg-white">
        <button
          type="button" data-bs-toggle="modal" data-bs-target="#basicModal"
          className="btn btn-md btn-thin btn-primary rounded-xl w-100"
        >
          Book A Valet Now
        </button>
      </div>
