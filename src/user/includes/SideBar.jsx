...
<TokenValidator />
  {/* Sidebar */}
  <div className="sidebar dz-floting-sidebar">
    <div className="sidebar-header">
      ...
      <div className="title-bar mb-0">
        ...
        <a href="javascript:void(0);" className="floating-close">
    ...
    <ul className="nav navbar-nav">
      ...
      <li>
        <a className="nav-link" href="my-order.html">
          <span className="dz-icon">
            <svg
              width={24}
              height={24}
      ...
      <li>
        <a className="nav-link" href="chat-list.html">
          <span className="dz-icon">
    ...
    <div className="sidebar-bottom">
      <div className="dz-mode">
        <div className="theme-btn">
          <i className="feather icon-sun sun" />
          <i className="feather icon-moon moon" />
        </div>
      </div>
      <div className="app-info">
        <h6 className="name">Ombe Coffee Shop</h6>
        <span className="ver-info">App Version 1.1</span>
      </div>
    </div>
  </div>
  {/* Sidebar End */}
