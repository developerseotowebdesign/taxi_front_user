              ...
              <div className="col-12 tracking-header  m-t80">
                <div className="card flex-row p-2">
                  ...
                  >
                    ...
                    <i class="ri-record-circle-fill fs-4 text-dark"></i>
                  </div>
                  ...
                  <div className="card-body p-0 ">
                    <div className="mb-2 input-group input-group-icon mt-1">
                      ...
                      <div className="d-flex align-items-center">
                        <i
                          class="ri-close-circle-fill fs-3 cursor"
                          onClick={clearPickup}
                        ></i>
                      </div>
                    </div>
...
<div className='bg-dark-shadow-fix desk-none'>
      ...
      <div className={`${!ConfirmLocation && "d-none"}`}>
        <div
          class={`offcanvas  shadow-sm border offcanvas-bottom ${
          ...
          <div className="offcanvas-body small">
            ...
            <div className="row mb-2">
              <div className="col-6 text-center">
                <div class="bg-primary py-2 text-white px-1 border rounded fs-7">
                  {" "}
                  Estimate Distance <br /> {Totaldistance}{" "}
                </div>
              </div>
              <div className="col-6 text-center">
                <div class="bg-primary text-white px-1  py-2 border rounded fs-7">
                  {" "}
